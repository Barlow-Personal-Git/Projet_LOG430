...
pub fn seed_inventaires(conn: &mut PgConnection) -> QueryResult<()> {
    ...
    let inventaires = vec![
        NouveauInventaire {
            id_produit: produits_list[0].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Breuvage",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[1].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Breuvage",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[2].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Breuvage",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[3].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Fruit",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[4].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Fruit",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[5].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Fruit",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[6].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Collation",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[7].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Collation",
            nbr: 200,
        },
        NouveauInventaire {
            id_produit: produits_list[8].id_produit,
            id_magasin: central_magasin.id_magasin,
            category: "Collation",
            nbr: 200,
        },
