use prometheus::{Encoder, TextEncoder, CounterVec, Histogram, Registry, histogram_opts};
use rocket::get;
use lazy_static::lazy_static;
use rocket::response::content::RawText;

lazy_static! {
    pub static ref REGISTRY: Registry = Registry::new_custom(Some("centre_logistique".into()), None).unwrap();
